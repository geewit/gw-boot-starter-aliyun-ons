 ...
 * <blockquote>com.aliyun.openservices.shade.org.apache.commons/codec/language/bm/${{@link NameType#getName()} languages.txt</blockquote>
 * <p>
...
public class Languages {
    ...
    // exposes com.aliyun.openservices.shade.org.apache.commons/codec/language/bm/%s_languages.txt for %s in NameType.* as a list of supported
    ...
    private static String langResourceName(final NameType nameType) {
        return String.format("com.aliyun.openservices.shade.org.apache.commons/codec/language/bm/%s_languages.txt", nameType.getName());
    }
