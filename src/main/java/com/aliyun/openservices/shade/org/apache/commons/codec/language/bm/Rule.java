 ...
 * <blockquote>com.aliyun.openservices.shade.org.apache.commons/codec/language/bm/${NameType#getName}_${RuleType#getName}_${language}.txt</blockquote>
 * <p>
...
public class Rule {
    ...
    private static String createResourceName(final NameType nameType, final RuleType rt, final String lang) {
        return String.format("com.aliyun.openservices.shade.org.apache.commons/codec/language/bm/%s_%s_%s.txt",
    ...
    private static Scanner createScanner(final String lang) {
        final String resName = String.format("com.aliyun.openservices.shade.org.apache.commons/codec/language/bm/%s.txt", lang);
        final InputStream rulesIS = Languages.class.getClassLoader().getResourceAsStream(resName);
