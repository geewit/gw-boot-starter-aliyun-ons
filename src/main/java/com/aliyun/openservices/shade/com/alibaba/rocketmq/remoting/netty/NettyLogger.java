...
public class NettyLogger {
    ...
    public static void initNettyLogger() {
        if (!nettyLoggerSeted.get()) {
            try {
                com.aliyun.openservices.shade.io.netty.util.internal.logging.InternalLoggerFactory.setDefaultFactory(new NettyBridgeLoggerFactory());
            } catch (Throwable e) {
                //ignore
            }
    ...
    private static class NettyBridgeLoggerFactory extends com.aliyun.openservices.shade.io.netty.util.internal.logging.InternalLoggerFactory {
        @Override
        protected com.aliyun.openservices.shade.io.netty.util.internal.logging.InternalLogger newInstance(String s) {
            return new NettyBridgeLogger(s);
        }
    }

    private static class NettyBridgeLogger implements com.aliyun.openservices.shade.io.netty.util.internal.logging.InternalLogger {
