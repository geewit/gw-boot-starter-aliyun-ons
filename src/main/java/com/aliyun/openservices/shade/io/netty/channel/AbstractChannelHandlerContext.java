...
import static com.aliyun.openservices.shade.io.netty.channel.DefaultChannelPipeline.*;
...
abstract class AbstractChannelHandlerContext extends DefaultAttributeMap implements ChannelHandlerContext {
    ...
    abstract static class AbstractWriteTask implements Runnable {
        ...
        private static final boolean ESTIMATE_TASK_SIZE_ON_SUBMIT =
                SystemPropertyUtil.getBoolean("com.aliyun.openservices.shade.io.netty.transport.estimateSizeOnSubmit", true);

        // Assuming a 64-bit JVM, 16 bytes object header, 3 reference fields and one int field, plus alignment
        private static final int WRITE_TASK_OVERHEAD =
                SystemPropertyUtil.getInt("com.aliyun.openservices.shade.io.netty.transport.writeTaskSizeOverhead", 48);
