...
import static com.aliyun.openservices.shade.io.netty.handler.ssl.SslUtils.getEncryptedPacketLength;
    ...
    private boolean ignoreException(Throwable t) {
        if (!(t instanceof SSLException) && t instanceof IOException && sslCloseFuture.isDone()) {
            ...
            for (StackTraceElement element: elements) {
                ...
                // skip all classes that belong to the com.aliyun.openservices.shade.io.netty package
                if (classname.startsWith("com.aliyun.openservices.shade.io.netty.")) {
                    continue;
                }
