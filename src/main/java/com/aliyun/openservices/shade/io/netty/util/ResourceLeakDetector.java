...
import static com.aliyun.openservices.shade.io.netty.util.internal.StringUtil.EMPTY_STRING;
import static com.aliyun.openservices.shade.io.netty.util.internal.StringUtil.NEWLINE;
import static com.aliyun.openservices.shade.io.netty.util.internal.StringUtil.simpleClassName;
...
public class ResourceLeakDetector<T> {
    ...
    static {
        ...
        if (SystemPropertyUtil.get("com.aliyun.openservices.shade.io.netty.noResourceLeakDetection") != null) {
            disabled = SystemPropertyUtil.getBoolean("com.aliyun.openservices.shade.io.netty.noResourceLeakDetection", false);
    ...
    private static final String[] STACK_TRACE_ELEMENT_EXCLUSIONS = {
            "com.aliyun.openservices.shade.io.netty.buffer.AbstractByteBufAllocator.toLeakAwareBuffer(",
            "com.aliyun.openservices.shade.io.netty.buffer.AdvancedLeakAwareByteBuf.recordLeakNonRefCountingOperation("
    };
