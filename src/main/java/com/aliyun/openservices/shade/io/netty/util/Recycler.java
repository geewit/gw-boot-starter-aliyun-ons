...
import static com.aliyun.openservices.shade.io.netty.util.internal.MathUtil.safeFindNextPositivePowerOfTwo;
...
public abstract class Recycler<T> {
    ...
    static {
        ...
        // e.g. com.aliyun.openservices.shade.io.netty.recycler.maxCapacity.writeTask
        //      com.aliyun.openservices.shade.io.netty.recycler.maxCapacity.outboundBuffer
        int maxCapacity = SystemPropertyUtil.getInt("com.aliyun.openservices.shade.io.netty.recycler.maxCapacity.default",
        ...
        MAX_SHARED_CAPACITY_FACTOR = max(2,
                SystemPropertyUtil.getInt("com.aliyun.openservices.shade.io.netty.recycler.maxSharedCapacityFactor",
                        2));

        MAX_DELAYED_QUEUES_PER_THREAD = max(0,
                SystemPropertyUtil.getInt("com.aliyun.openservices.shade.io.netty.recycler.maxDelayedQueuesPerThread",
                        // We use the same value as default EventLoop number
                        Runtime.getRuntime().availableProcessors() * 2));

        LINK_CAPACITY = safeFindNextPositivePowerOfTwo(
                max(SystemPropertyUtil.getInt("com.aliyun.openservices.shade.io.netty.recycler.linkCapacity", 16), 16));

        // By default we allow one push to a Recycler for each 8th try on handles that were never recycled before.
        // This should help to slowly increase the capacity of the recycler while not be too sensitive to allocation
        // bursts.
        RATIO = safeFindNextPositivePowerOfTwo(SystemPropertyUtil.getInt("com.aliyun.openservices.shade.io.netty.recycler.ratio", 8));
