...
import static com.aliyun.openservices.shade.io.netty.channel.sctp.SctpChannelOption.*;
...
public class DefaultSctpChannelConfig extends DefaultChannelConfig implements SctpChannelConfig {
    ...
    public DefaultSctpChannelConfig(com.aliyun.openservices.shade.io.netty.channel.sctp.SctpChannel channel, SctpChannel javaChannel) {
        super(channel);
        if (javaChannel == null) {
