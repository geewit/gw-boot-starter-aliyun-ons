...
public final class NativeLibraryLoader {
    ...
    static {
        ...
        String workdir = SystemPropertyUtil.get("com.aliyun.openservices.shade.io.netty.native.workdir");
        if (workdir != null) {
            ...
            WORKDIR = tmpdir();
            logger.debug("-Dio.netty.native.workdir: " + WORKDIR + " (com.aliyun.openservices.shade.io.netty.tmpdir)");
        }
    }
