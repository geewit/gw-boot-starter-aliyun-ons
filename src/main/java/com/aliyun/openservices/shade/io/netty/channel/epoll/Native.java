...
import com.aliyun.openservices.shade.io.netty.util.internal.NativeLibraryLoader;
...
import static com.aliyun.openservices.shade.io.netty.channel.epoll.NativeStaticallyReferencedJniMethods.epollerr;
import static com.aliyun.openservices.shade.io.netty.channel.epoll.NativeStaticallyReferencedJniMethods.epollet;
import static com.aliyun.openservices.shade.io.netty.channel.epoll.NativeStaticallyReferencedJniMethods.epollin;
import static com.aliyun.openservices.shade.io.netty.channel.epoll.NativeStaticallyReferencedJniMethods.epollout;
import static com.aliyun.openservices.shade.io.netty.channel.epoll.NativeStaticallyReferencedJniMethods.epollrdhup;
import static com.aliyun.openservices.shade.io.netty.channel.epoll.NativeStaticallyReferencedJniMethods.iovMax;
import static com.aliyun.openservices.shade.io.netty.channel.epoll.NativeStaticallyReferencedJniMethods.isSupportingSendmmsg;
import static com.aliyun.openservices.shade.io.netty.channel.epoll.NativeStaticallyReferencedJniMethods.isSupportingTcpFastopen;
import static com.aliyun.openservices.shade.io.netty.channel.epoll.NativeStaticallyReferencedJniMethods.kernelVersion;
import static com.aliyun.openservices.shade.io.netty.channel.epoll.NativeStaticallyReferencedJniMethods.ssizeMax;
import static com.aliyun.openservices.shade.io.netty.channel.epoll.NativeStaticallyReferencedJniMethods.tcpMd5SigMaxKeyLen;
import static com.aliyun.openservices.shade.io.netty.channel.epoll.NativeStaticallyReferencedJniMethods.uioMaxIov;
import static com.aliyun.openservices.shade.io.netty.channel.unix.Errors.ERRNO_EAGAIN_NEGATIVE;
import static com.aliyun.openservices.shade.io.netty.channel.unix.Errors.ERRNO_EPIPE_NEGATIVE;
import static com.aliyun.openservices.shade.io.netty.channel.unix.Errors.ERRNO_EWOULDBLOCK_NEGATIVE;
import static com.aliyun.openservices.shade.io.netty.channel.unix.Errors.ioResult;
import static com.aliyun.openservices.shade.io.netty.channel.unix.Errors.newConnectionResetException;
import static com.aliyun.openservices.shade.io.netty.channel.unix.Errors.newIOException;
...
public final class Native {
    ...
    private static void loadNativeLibrary() {
        ...
        NativeLibraryLoader.load(SystemPropertyUtil.get("com.aliyun.openservices.shade.io.netty.packagePrefix", "").replace('.', '-') +
