 ...
 * the system property <strong>com.aliyun.openservices.shade.io.netty.noUnsafe</strong>.
 */
public final class PlatformDependent {
    ...
    private static final boolean DIRECT_BUFFER_PREFERRED =
            HAS_UNSAFE && !SystemPropertyUtil.getBoolean("com.aliyun.openservices.shade.io.netty.noPreferDirect", false);
    ...
    static {
        ...
        long maxDirectMemory = SystemPropertyUtil.getLong("com.aliyun.openservices.shade.io.netty.maxDirectMemory", -1);
        ...
        logger.debug("com.aliyun.openservices.shade.io.netty.maxDirectMemory: {} bytes", maxDirectMemory);
    }
    ...
    private static boolean explicitNoUnsafe0() {
        final boolean noUnsafe = SystemPropertyUtil.getBoolean("com.aliyun.openservices.shade.io.netty.noUnsafe", false);
        logger.debug("-Dio.netty.noUnsafe: {}", noUnsafe);

        if (noUnsafe) {
            logger.debug("sun.misc.Unsafe: unavailable (com.aliyun.openservices.shade.io.netty.noUnsafe)");
            return true;
        }

        // Legacy properties
        boolean tryUnsafe;
        if (SystemPropertyUtil.contains("com.aliyun.openservices.shade.io.netty.tryUnsafe")) {
            tryUnsafe = SystemPropertyUtil.getBoolean("com.aliyun.openservices.shade.io.netty.tryUnsafe", true);
        } else {
            tryUnsafe = SystemPropertyUtil.getBoolean("org.jboss.netty.tryUnsafe", true);
        }

        if (!tryUnsafe) {
            logger.debug("sun.misc.Unsafe: unavailable (com.aliyun.openservices.shade.io.netty.tryUnsafe/org.jboss.netty.tryUnsafe)");
            return true;
        }
    ...
    private static boolean hasJavassist0() {
        ...
        boolean noJavassist = SystemPropertyUtil.getBoolean("com.aliyun.openservices.shade.io.netty.noJavassist", false);
        logger.debug("-Dio.netty.noJavassist: {}", noJavassist);

        if (noJavassist) {
            logger.debug("Javassist: unavailable (com.aliyun.openservices.shade.io.netty.noJavassist)");
            return false;
        }
    ...
    private static File tmpdir0() {
        File f;
        try {
            f = toDirectory(SystemPropertyUtil.get("com.aliyun.openservices.shade.io.netty.tmpdir"));
            if (f != null) {
    ...
    private static int bitMode0() {
        ...
        int bitMode = SystemPropertyUtil.getInt("com.aliyun.openservices.shade.io.netty.bitMode", 0);
        if (bitMode > 0) {
