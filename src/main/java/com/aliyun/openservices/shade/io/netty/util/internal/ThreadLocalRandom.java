 ...
 * tasks (for example, each a {@link com.aliyun.openservices.shade.io.netty.util.internal.chmv8.ForkJoinTask}) use random numbers
    ...
    public static synchronized long getInitialSeedUniquifier() {
        ...
        if (initialSeedUniquifier == 0) {
            ...
            ThreadLocalRandom.initialSeedUniquifier = initialSeedUniquifier = AccessController.doPrivileged(
                ...
                @Override
                public Long run() {
                    return Long.getLong("com.aliyun.openservices.shade.io.netty.initialSeedUniquifier", 0);
                }
            });
        }
