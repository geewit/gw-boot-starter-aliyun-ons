...
public interface DomainSocketChannelConfig extends ChannelConfig {
     ...
     * {@link com.aliyun.openservices.shade.io.netty.channel.Channel} and passed through the pipeline. If
     * {@link DomainSocketReadMode#FILE_DESCRIPTORS} is used
     * {@link FileDescriptor}s will be passed through the {@link com.aliyun.openservices.shade.io.netty.channel.ChannelPipeline}.
     *
