        ...
        DefaultResourceLeakDetectorFactory() {
            ...
            try {
                customLeakDetector = AccessController.doPrivileged(new PrivilegedAction<String>() {
                    @Override
                    public String run() {
                        return SystemPropertyUtil.get("com.aliyun.openservices.shade.io.netty.customResourceLeakDetector");
                    }
                });
            } catch (Throwable cause) {
                logger.error("Could not access System property: com.aliyun.openservices.shade.io.netty.customResourceLeakDetector", cause);
