...
public class PooledByteBufAllocator extends AbstractByteBufAllocator {
    ...
    static {
        int defaultPageSize = SystemPropertyUtil.getInt("com.aliyun.openservices.shade.io.netty.allocator.pageSize", 8192);
        ...
        int defaultMaxOrder = SystemPropertyUtil.getInt("com.aliyun.openservices.shade.io.netty.allocator.maxOrder", 11);
        ...
        DEFAULT_NUM_HEAP_ARENA = Math.max(0,
                SystemPropertyUtil.getInt(
                        "com.aliyun.openservices.shade.io.netty.allocator.numHeapArenas",
                        (int) Math.min(
                                defaultMinNumArena,
                                runtime.maxMemory() / defaultChunkSize / 2 / 3)));
        DEFAULT_NUM_DIRECT_ARENA = Math.max(0,
                SystemPropertyUtil.getInt(
                        "com.aliyun.openservices.shade.io.netty.allocator.numDirectArenas",
                        (int) Math.min(
                                defaultMinNumArena,
        ...
        DEFAULT_MAX_CACHED_BUFFER_CAPACITY = SystemPropertyUtil.getInt(
                "com.aliyun.openservices.shade.io.netty.allocator.maxCachedBufferCapacity", 32 * 1024);

        // the number of threshold of allocations when cached entries will be freed up if not frequently used
        DEFAULT_CACHE_TRIM_INTERVAL = SystemPropertyUtil.getInt(
                "com.aliyun.openservices.shade.io.netty.allocator.cacheTrimInterval", 8192);
    ...
    /**
     *  Default number of heap areanas - System Property: com.aliyun.openservices.shade.io.netty.allocator.numHeapArenas - default 2 * cores
     */
    ...
    /**
     *  Default numer of direct arenas - System Property: com.aliyun.openservices.shade.io.netty.allocator.numDirectArenas - default 2 * cores
     */
    ...
    /**
     * Default buffer page size - System Property: com.aliyun.openservices.shade.io.netty.allocator.pageSize - default 8192
     */
    ...
    /**
     *  Default maximum order - System Property: com.aliyun.openservices.shade.io.netty.allocator.maxOrder - default 11
     */
    ...
    /**
     *  Default tiny cache size - System Property: com.aliyun.openservices.shade.io.netty.allocator.tinyCacheSize - default 512
     */
    ...
    /**
     *  Default small cache size - System Property: com.aliyun.openservices.shade.io.netty.allocator.smallCacheSize - default 256
     */
    ...
    /**
     *  Default normal cache size - System Property: com.aliyun.openservices.shade.io.netty.allocator.normalCacheSize - default 64
     */
