...
import static com.aliyun.openservices.shade.io.netty.util.internal.MathUtil.isOutOfBounds;
import static com.aliyun.openservices.shade.io.netty.util.internal.ObjectUtil.checkNotNull;
import static com.aliyun.openservices.shade.io.netty.util.internal.StringUtil.NEWLINE;
import static com.aliyun.openservices.shade.io.netty.util.internal.StringUtil.isSurrogate;
...
public final class ByteBufUtil {
    ...
    static {
        String allocType = SystemPropertyUtil.get("com.aliyun.openservices.shade.io.netty.allocator.type", "unpooled").toLowerCase(Locale.US).trim();
        ...
        THREAD_LOCAL_BUFFER_SIZE = SystemPropertyUtil.getInt("com.aliyun.openservices.shade.io.netty.threadLocalDirectBufferSize", 64 * 1024);
        logger.debug("-Dio.netty.threadLocalDirectBufferSize: {}", THREAD_LOCAL_BUFFER_SIZE);

        MAX_CHAR_BUFFER_SIZE = SystemPropertyUtil.getInt("com.aliyun.openservices.shade.io.netty.maxThreadLocalCharBufferSize", 16 * 1024);
